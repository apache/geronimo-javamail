...
import org.apache.geronimo.mail.store.imap.connection.IMAPFetchResponse;
 ...
 * As per the mail spec items from the actual message will get filled up on demand
 *
