...
```
/Users/cesar/.sdkman/candidates/java/8/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005 -verify javasoft.sqe.tests.javax.mail.Address.equals_Test -t imap -tp smtp -h localhost -pn 1143 -th localhost -tpn 1025 -u 'user01@james.loca'l -p 1234  -m test1 -D
```
